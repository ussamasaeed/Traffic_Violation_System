...
# CAPTURE THRESHOLDS
# ===========================================================
MIN_BOX_WIDTH = 60    # pixels
MIN_BOX_HEIGHT = 40   # pixels
...
# ===========================================================
# DataFrame for input LSTM Model
# ===========================================================
...
def process_video(video_path, progress_actor=None):
    ...
    try:
        ...
        captured = set()  # prevent duplicate captures
            ...
            for track in tracks:
                try:
                    ...
                    if best_yolo_box is not None:
                        ...
                        if box_w >= MIN_BOX_WIDTH and box_h >= MIN_BOX_HEIGHT:
                            if y2 < bottom_line:
                                if unique_id not in captured:
                                    crop = frame[cy1:cy2, cx1:cx2]
                                    if crop.size > 0:
                                        fname = os.path.join(IMG_SAVE_DIR, f"{unique_id}.jpg")
                                        try:
